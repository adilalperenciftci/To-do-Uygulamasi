...
export const ProfileAvatar = ({ user, setUser }: UserProps) => {
  ...
  return (
    <Container>
      <Tooltip title={user.name || "Kullanıcı"}>
        <IconButton
          id="basic-button"
        ...
        >
          <Avatar
            ...
            onError={() => {
              ...
              toast.error("Profil resmi URL'sinde hata");
      ...
      >
        ...
        >
          ...
          <h2>
            <span style={{ color: "#7764E8" }}>Todo</span> Uygulaması
        ...
        >
          <GetApp /> &nbsp; İçe/Dışa Aktar
        </StyledMenuItem>

        <Divider sx={{ margin: "0 8px" }} />
        <StyledMenuItem
          onClick={() => {
            window.open("https://github.com/adilalperenciftci");
          }}
        >
          <GitHub /> &nbsp; Github
        </StyledMenuItem>
        ...
        >
          ...
          >
            ...
            <h4 style={{ margin: 0, fontWeight: 600 }}> {user.name || "Kullanıcı"}</h4>
          </StyledMenuItem>
          <span
            style={{
              fontSize: "12px",
          ...
          >
            <span style={{ display: "flex", alignItems: "center" }}>
              Tarafından &nbsp; <Favorite sx={{ fontSize: "16px" }} />
            </span>
            <span style={{ marginLeft: "6px", marginRight: "4px" }}>Yapıldı</span>{" "}
            <a
