        ...
        <div>
          ...
          const handleEditCategory = () => {
            if (selectedCategoryId) {
              ...
              toast.success(() => (
                <div>
                  Kategori güncellendi - <b>{editName}</b>
                </div>
              ));
              setOpenEditDialog(false);
            }
            ...
            <>
              ...
              <Container>
                {user.categories.length > 0 ? (
                      ...
                      return (
                        <CategoryDiv key={category.id} clr={category.color}>
                          <CategoryContent>
                            ...
                            <Tooltip title="Bu kategoriye atanan görevlerin tamamlanma yüzdesi">
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  ...
                                  if (totalTasksCount > 0) {
                                    // Eğer kategoriye bağlı görevler varsa silme iletişim kutusunu aç
                                    setOpenDeleteDialog(true);
                                  } else {
                                    // Eğer bağlı görev yoksa doğrudan silme işlemini gerçekleştir
                  ...
                  <p>Herhangi bir kategori bulunmamaktadır</p>
                )}
                <AddContainer>
                ...
                >
                  <DialogTitle>
                    <b>{user.categories.find((cat) => cat.id === selectedCategoryId)?.name}</b> kategorisini silmeyi onayla
                  </DialogTitle>

                  <DialogContent>
                    Bu, kategoriyi ve ilişkili görevleri listenizden kaldıracaktır.
                  </DialogContent>

                  <DialogActions>
                    <DialogBtn onClick={() => setOpenDeleteDialog(false)}>İptal</DialogBtn>
                    <DialogBtn
                      onClick={() => {
                ...
                >
                  ...
                  <DialogActions>
                    <DialogBtn onClick={handleEditDimiss}>İptal</DialogBtn>
